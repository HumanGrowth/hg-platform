...
export function PathBottleneckCta() {
  ...
  return (
    <div className="mb-8 flex flex-col gap-3 rounded-lg border border-hg-green-100 bg-hg-green-100 p-5 sm:flex-row sm:items-center sm:justify-between">
      ...
      <a
        href={`#lane-${pillar}`}
        className="inline-flex shrink-0 items-center gap-2 self-start rounded-md bg-orange px-4 py-2 font-sans text-sm font-semibold text-white hover:bg-primary-hover sm:self-auto"
      >
        Ver cursos
