    ...
    <div className="overflow-hidden rounded-lg border border-border bg-bg-raised">
      ...
      <div className="flex flex-col gap-5 p-6 sm:flex-row sm:items-center">
        ...
        <Link
          ...
          className="relative flex aspect-video w-full shrink-0 items-center justify-center overflow-hidden rounded-lg bg-bg-sunken text-fg-subtle sm:aspect-auto sm:h-24 sm:w-44"
        >
          <UnitThumbnail
